...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Slot', fields ['date', 'line', 'block', 'timeslot']
        db.create_unique('timeslots_slot', ['date', 'line', 'block_id', 'timeslot'])


    def backwards(self, orm):
        # Removing unique constraint on 'Slot', fields ['date', 'line', 'block', 'timeslot']
        db.delete_unique('timeslots_slot', ['date', 'line', 'block_id', 'timeslot'])
