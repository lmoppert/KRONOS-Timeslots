...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.opened_on_weekend'
        db.add_column('timeslots_station', 'opened_on_weekend',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Station.opened_on_weekend'
        db.delete_column('timeslots_station', 'opened_on_weekend')
