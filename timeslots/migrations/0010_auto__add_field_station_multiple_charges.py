...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.multiple_charges'
        db.add_column('timeslots_station', 'multiple_charges',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Station.multiple_charges'
        db.delete_column('timeslots_station', 'multiple_charges')
