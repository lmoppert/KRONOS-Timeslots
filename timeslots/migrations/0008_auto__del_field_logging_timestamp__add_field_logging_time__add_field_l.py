...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Logging.timestamp'
        db.delete_column('timeslots_logging', 'timestamp')

        # Adding field 'Logging.time'
        db.add_column('timeslots_logging', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 7, 24, 0, 0)),
                      keep_default=False)

        # Adding field 'Logging.host'
        db.add_column('timeslots_logging', 'host',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Logging.timestamp'
        db.add_column('timeslots_logging', 'timestamp',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2012, 7, 24, 0, 0)),
                      keep_default=False)

        # Deleting field 'Logging.time'
        db.delete_column('timeslots_logging', 'time')

        # Deleting field 'Logging.host'
        db.delete_column('timeslots_logging', 'host')
