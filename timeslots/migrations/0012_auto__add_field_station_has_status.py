...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.has_status'
        db.add_column('timeslots_station', 'has_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Station.has_status'
        db.delete_column('timeslots_station', 'has_status')
