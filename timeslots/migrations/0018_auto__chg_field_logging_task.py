...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('timeslots_logging', 'task', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Logging.task'
        db.alter_column('timeslots_logging', 'task', self.gf('django.db.models.fields.CharField')(max_length=200))
