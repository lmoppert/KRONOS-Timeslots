...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Block.max_slots'
        db.add_column('timeslots_block', 'max_slots',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Block.max_slots'
        db.delete_column('timeslots_block', 'max_slots')
    ...
    models = {
        ...
        'timeslots.slot': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timeslots.UserProfile']", 'blank': 'True'}),
