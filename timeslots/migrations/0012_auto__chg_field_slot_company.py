...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Slot.company'
        db.alter_column('timeslots_slot', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timeslots.UserProfile'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Slot.company'
        raise RuntimeError("Cannot reverse this migration. 'Slot.company' and its values cannot be restored.")
    ...
    models = {
        ...
        'timeslots.slot': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timeslots.UserProfile']", 'null': 'True', 'blank': 'True'}),
