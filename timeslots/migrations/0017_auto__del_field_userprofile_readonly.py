...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.readonly'
        db.delete_column('timeslots_userprofile', 'readonly')


    def backwards(self, orm):
        # Adding field 'UserProfile.readonly'
        db.add_column('timeslots_userprofile', 'readonly',
