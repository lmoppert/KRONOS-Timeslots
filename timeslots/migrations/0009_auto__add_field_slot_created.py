...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slot.created'
        db.add_column('timeslots_slot', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 7, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slot.created'
        db.delete_column('timeslots_slot', 'created')
